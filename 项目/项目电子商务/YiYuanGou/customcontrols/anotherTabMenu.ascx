<%@ Control Language="C#" AutoEventWireup="true" CodeFile="anotherTabMenu.ascx.cs" Inherits="customcontrols_anotherTabMenu" %>
			    ...
			    <ul>
                    ...
                    <li class="">
                        <a href="#"><span>
                            ...
                            <asp:Button ID="sreach" runat="server" onclick="sreach_Click" Height="20px" Width="50px" Text="一元搜" />
                        </span></a>
                   </li>
                   <li class="">
                        <a href="#"><span>
                            <asp:Button ID="Button1" runat="server" Text="购物车" Height="20px" Width="50px" onclick="Button1_Click" />
                        </span></a>
                    </li>
			    </ul>
		    </div>
