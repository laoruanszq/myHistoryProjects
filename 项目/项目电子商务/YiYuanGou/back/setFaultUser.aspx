<%@ Page Language="C#" AutoEventWireup="true" CodeFile="setFaultUser.aspx.cs" Inherits="back_setFaultUser" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>设置虚拟用户比例</title>
...
<li><a href="WebManage/sendMail.aspx">站内信</a></li>
  ...
  <ul class="categoryitems">
    ...
    <li><a href="setHotRoom.aspx">房间开关</a></li>
     ...
     <div id="rightmid">
      <div id="position">所在位置：系统设置&gt;&gt;设置比例</div>
      <div id="list_a">
          房间列表<br />
     <br />
     <div id="listposition">
...
&nbsp;&nbsp;&nbsp;
    ...
    <div>
      <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"  AllowPaging="True" 
            ...
            style="margin-left: 0px" Width="899px" >
            <Columns>
                ...
                <asp:TemplateField HeaderText="当前比例%">
                  <ItemTemplate> <asp:TextBox ID="TextBox5" runat="server" Text='<%# Eval("currRatio")%>' /> </ItemTemplate>  
                    <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="30px" /> 
                </asp:TemplateField>
                <asp:TemplateField HeaderText="新设比例%">
                  <ItemTemplate> <asp:TextBox ID="TextBox4" runat="server" Text='<%# Eval("newFaultUser") %>' /> </ItemTemplate>  
                    <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="30px" /> 
                </asp:TemplateField>
            </Columns>
      ...
      <asp:Button ID="Button1" runat="server" Text="设定" onclick="Button1_Click" 
        onclientclick="return confirm('您确实要重新设置这些房间的水军比例吗?')" />
    </form>
     </div>
      </div>
