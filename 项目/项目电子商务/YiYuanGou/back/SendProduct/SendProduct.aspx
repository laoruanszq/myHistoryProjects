<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SendProduct.aspx.cs" Inherits="back_SendProduct_Default" %>
...
<li><a href="../WebManage/sendMail.aspx">站内信</a></li>
  ...
  <ul class="categoryitems">
    ...
    <li><a href="../setHotRoom.aspx">房间开关</a></li>
     ...
     <div id="rightmid">
      <div id="position">所在位置：订单中心&gt;&gt;发货管理</div>
      <div id="list_a">
      发货列表
      <br />
      <br />
    ...
    <div id="listposition">
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"  AllowPaging="True" 
            ...
            style="margin-left: 0px" Width="908px" >
            <Columns>
        ...
        <asp:Button ID="Button1" runat="server" Text="提交" onclick="Button1_Click" 
            onclientclick="return confirm('你确实要发送这些货物，并已经邮件通知客户了吗?')" />
&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Button ID="Button2" runat="server" onclick="Button2_Click" Text="邮件通知" />
        &nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Button ID="Button3" runat="server" onclick="Button3_Click" Text="当场领走" />
        </p>
    </div>
