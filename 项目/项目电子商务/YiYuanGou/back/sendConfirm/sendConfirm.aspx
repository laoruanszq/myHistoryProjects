<%@ Page Language="C#" AutoEventWireup="true" CodeFile="sendConfirm.aspx.cs" Inherits="back_sendConfirm_sendConfirm" %>
...
<li><a href="../WebManage/sendMail.aspx">站内信</a></li>
  ...
  <ul class="categoryitems">
    ...
    <li><a href="../setHotRoom.aspx">房间开关</a></li>
     ...
     <div id="rightmid">
      <div id="position">所在位置：用户中心&gt;订单确认</div>
      <div id="list_a">
      订单列表
      <br />
      <br />
...
&nbsp;&nbsp;&nbsp;
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"  AllowPaging="True" 
            ...
            style="margin-left: 0px" Width="901px" >
            <Columns>
                ...
                <asp:BoundField DataField="roomID" HeaderText="RoomID" ReadOnly="True" Visible="False" />               
            </Columns>
            <HeaderStyle BackColor="#CCFF66" />
        </asp:GridView>
    <p>
        <asp:Button ID="Button1" runat="server" Text="物流确认已送达" 
            onclick="Button1_Click" onclientclick="return confirm('用户确实已经收到这些货物吗?')" />
&nbsp;&nbsp;&nbsp;&nbsp;
        </p>
    </div>
