<%@ Page Language="C#" AutoEventWireup="true" CodeFile="back_index.aspx.cs" Inherits="back_back_index" %>
...
<div id="header">
    ...
    <div id="info">
        <a href="admin/changePWD.aspx">修改密码</a> |  
...
<li><a href="WebManage/sendMail.aspx">站内信</a></li>
  ...
  <ul class="categoryitems">
    ...
    <div id="right">
      <div id="position">所在位置：后台首页      </div>
      <div id="list_a">用户信息
      <br>
      <table width="685" height="123" border="0">
  <tr>
    <td width="461">当前用户：</td>
    <td width="214">&nbsp;</td>
  </tr>
  <tr>
    <td>用户类型：</td>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
      ...
      <div id="list_a"><br /><br /><br /></div>
      <div id="list_a"><br /><br /><br /></div>
      <div id="list_a"><br /><br /><br /></div>
    </div>
  </div>
<div id="footer">
<div id="footerinfo">底部信息</div>
</div>
