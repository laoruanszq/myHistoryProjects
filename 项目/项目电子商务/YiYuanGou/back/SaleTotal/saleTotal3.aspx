<%@ Page Language="C#" AutoEventWireup="true" CodeFile="saleTotal3.aspx.cs" Inherits="back_SaleTotal_saleTotal3" %>
...
<li><a href="../WebManage/sendMail.aspx">站内信</a></li>
  ...
  <ul class="categoryitems">
    ...
    <li><a href="../setHotRoom.aspx">房间开关</a></li>
     ...
     <div id="right">
      <div id="position">所在位置：销售中心&gt;&gt;按用户统计</div>
      <div id="list_a">
          统计列表<br />
     <br />
     <div id="listposition">
...
&nbsp;&nbsp;
        <asp:Button ID="Button2" runat="server" Text="重设" onclick="Button2_Click" />
            ...
            <Columns>
                ...
                <asp:BoundField DataField="userName" HeaderText="昵称" ReadOnly="True" />
                <asp:BoundField DataField="trueName" HeaderText="姓名" ReadOnly="True" />
                <asp:BoundField DataField="university_Province" HeaderText="所在学校/省" ReadOnly="True" />                
                <asp:BoundField DataField="college_City" HeaderText="所在学院/市" ReadOnly="True" />
                <asp:BoundField DataField="zongshu" HeaderText="购买总数" ReadOnly="True" />
            </Columns>
