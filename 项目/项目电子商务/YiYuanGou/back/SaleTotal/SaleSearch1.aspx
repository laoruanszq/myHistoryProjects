<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SaleSearch1.aspx.cs" Inherits="back_SaleTotal_Default" %>
...
<li><a href="../WebManage/sendMail.aspx">站内信</a></li>
  ...
  <ul class="categoryitems">
    ...
    <li><a href="../setHotRoom.aspx">房间开关</a></li>
     ...
     <div id="right">
      <div id="position">所在位置：销售中心&gt;&gt;商品销售</div>
      <div id="list_a">
          销售记录<br />
      <br />
...
&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <br />
        <br />
        购买时间从&nbsp; <asp:TextBox ID="TextBox2" runat="server"></asp:TextBox>
        &nbsp; 到&nbsp; <asp:TextBox ID="TextBox3" runat="server"></asp:TextBox>
        &nbsp; （例如：20120908）<br />
        <br />
        <br />
...
&nbsp;&nbsp;&nbsp;
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" AllowPaging="True" 
            ...
            <Columns>
                <asp:BoundField DataField="userID" HeaderText="购买用户" ReadOnly="True" />
                ...
                <asp:BoundField DataField="university_Province" HeaderText="学校/省" ReadOnly="True" />
                <asp:BoundField DataField="college_City" HeaderText="学院/市" ReadOnly="True" />
                <asp:BoundField DataField="statement" HeaderText="交易状态" ReadOnly="True" />
                <asp:BoundField DataField="roomID" HeaderText="购买方式" ReadOnly="True" />
                <asp:BoundField DataField="amount" HeaderText="购买数量" ReadOnly="True" />
                <asp:BoundField DataField="orderTime" HeaderText="购买日期" ReadOnly="True" />
                <asp:BoundField DataField="sendTime" HeaderText="发货日期" ReadOnly="True" />
                <asp:BoundField DataField="acceptTime" HeaderText="收货日期" ReadOnly="True" />
                <asp:BoundField DataField="rejectTime" HeaderText="退货日期" ReadOnly="True" />
            </Columns>
