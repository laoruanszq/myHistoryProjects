<%@ Page Language="C#" AutoEventWireup="true" CodeFile="saleSearch2.aspx.cs" Inherits="back_SaleTotal_saleSearch2" %>
...
<li><a href="../WebManage/sendMail.aspx">站内信</a></li>
  ...
  <ul class="categoryitems">
    ...
    <li><a href="../setHotRoom.aspx">房间开关</a></li>
     ...
     <div id="right">
      <div id="position">所在位置：销售中心&gt;&gt;购买记录</div>
      <div id="list_a">
          购买记录列表<br />
      <br />
      <div id="listposition">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <asp:DropDownList ID="DropDownList2" runat="server" Height="22px" Width="164px">
            ...
            <br />
            <br />
        购买时间从&nbsp; <asp:TextBox ID="TextBox4" runat="server"></asp:TextBox>
...
&nbsp;&nbsp;
        <asp:Button ID="Button2" runat="server" Text="重设" onclick="Button2_Click" />
            ...
            <Columns>
                <asp:BoundField DataField="productID" HeaderText="商品编号" ReadOnly="True" />
