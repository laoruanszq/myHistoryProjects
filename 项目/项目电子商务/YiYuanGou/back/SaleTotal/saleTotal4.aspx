<%@ Page Language="C#" AutoEventWireup="true" CodeFile="saleTotal4.aspx.cs" Inherits="back_SaleTotal_saleTotal4" %>
...
<li><a href="../WebManage/sendMail.aspx">站内信</a></li>
  ...
  <ul class="categoryitems">
    ...
    <li><a href="../setHotRoom.aspx">房间开关</a></li>
     ...
     <div id="right">
      <div id="position">所在位置：销售中心&gt;&gt;退货统计</div>
      <div id="list_a">
          统计列表<br />
     <br />
     <div id="listposition">
...
&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <br />
        购买方式：&nbsp; 
        <asp:DropDownList ID="DropDownList4" runat="server" Height="23px" AutoPostBack="True"
            onselectedindexchanged="DropDownList1_SelectedIndexChanged" Width="106px">
            <asp:ListItem Selected="True">所有</asp:ListItem>
            <asp:ListItem>换购</asp:ListItem>
            <asp:ListItem>占座</asp:ListItem>
        </asp:DropDownList>
        <br />
        <br />
...
&nbsp;&nbsp;&nbsp;
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" AllowPaging="True" 
            ...
            <Columns>
                <asp:BoundField DataField="proName" HeaderText="商品名" ReadOnly="True" />
                <asp:BoundField DataField="grandfather" HeaderText="一级分类" ReadOnly="True" />
                <asp:BoundField DataField="father" HeaderText="二级分类" ReadOnly="True" />
                <asp:BoundField DataField="pcName" HeaderText="三级分类" ReadOnly="True" />
                <asp:BoundField DataField="zongshu" HeaderText="销量总和" ReadOnly="True" />
                <asp:BoundField DataField="tuizongshu" HeaderText="退货总和" ReadOnly="True" />
                <asp:BoundField DataField="tuilv" HeaderText="退货率" ReadOnly="True" />
            </Columns>
