<%@ Page Language="C#" AutoEventWireup="true" CodeFile="offOnFaultUser.aspx.cs" Inherits="back_offOnFaultUser" %>
...
<li><a href="WebManage/sendMail.aspx">站内信</a></li>
  ...
  <ul class="categoryitems">
    ...
    <li><a href="setHotRoom.aspx">房间开关</a></li>
     ...
     <div id="right">
      <div id="position">所在位置：系统设置&gt;&gt;开启虚拟用户</div>
      <div id="list_a">
          房间列表<br />
     <br />
     <div id="listposition">
...
<div>
        ...
        <asp:DropDownList ID="DropDownList1" runat="server" Height="23px"  AutoPostBack="True"
            onselectedindexchanged="DropDownList1_SelectedIndexChanged" Width="103px">
        </asp:DropDownList>
        &nbsp;&nbsp;&nbsp;
...
&nbsp;&nbsp;&nbsp;
    ...
    <div>
      ...
      <asp:Button ID="Button1" runat="server" Text="设定" onclick="Button1_Click" 
        onclientclick="return confirm('您确实要为这些房间开启水军功能吗?')" />
    </form>
     </div>
      </div>
