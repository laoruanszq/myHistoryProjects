<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ModifyAccount.aspx.cs" Inherits="back_WebManage_Default" %>
...
<li><a href="../WebManage/sendMail.aspx">站内信</a></li>
  ...
  <ul class="categoryitems">
    ...
    <div>
        ...
        用户编号：<asp:TextBox ID="UserID"  runat="server" 
            Width="194px"></asp:TextBox>
        <asp:Button ID="Button3" runat="server" Text="确定" onclick="Button3_Click" />
        <br />
        <br />
        用户姓名：<asp:TextBox ID="UName" runat="server" ReadOnly="True" 
            Width="193px"></asp:TextBox>
        <br />
        <br />
        真实姓名：<asp:TextBox ID="TrueName" runat="server"></asp:TextBox>
        <br />
        <br />
        学号/身份证：<asp:TextBox ID="IdentifyNo" runat="server" Width="220px"></asp:TextBox>
        <br />
        <br />
        学校/省： 
        <asp:TextBox ID="University" runat="server" ReadOnly="True" Width="241px"></asp:TextBox>
        <br />
        <br />
        学院/市： 
        <asp:TextBox ID="Collage" runat="server" ReadOnly="True" Width="238px"></asp:TextBox>
        <br />
        <br />
        地址：&nbsp;&nbsp;<asp:TextBox ID="Address" runat="server" 
            ReadOnly="True" Width="236px"></asp:TextBox>
        <br />
        <br />
        当前余额：<asp:TextBox ID="Account" runat="server" ReadOnly="True"></asp:TextBox>
        <br />
        <br />
        充值数量：<asp:TextBox ID="Append" runat="server"></asp:TextBox>
        <br />
        <br />
    
    </div>
    <asp:Button ID="Button1" runat="server" Text="充值" onclick="Button1_Click" 
         onclientclick="return confirm('确实要给该用户充值吗?')" />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <asp:Button ID="Button2" runat="server" Text="重置" onclick="Button2_Click" />
    &nbsp;&nbsp;&nbsp;
    <asp:Button ID="Button4" runat="server" Text="打印凭证" onclick="Button4_Click" />
    </form>
    </div>
  </div>
