<%@ Page Language="C#" AutoEventWireup="true" CodeFile="showorder.aspx.cs" Inherits="front_ExpChangePro_showorder" %>
...
<body>
    ...
    <!--显示订单信息-->
     ...
     <div style="margin:0 auto;width:80%;">
         ...
         <br />
        &nbsp; 
                    <asp:HyperLink ID="HyperLink_confirm" runat="server">确认收货</asp:HyperLink>
                &nbsp; 
                    <asp:HyperLink ID="HyperLink_changed"
                        runat="server">修改订单</asp:HyperLink>
                &nbsp;
         <asp:HyperLink ID="HyperLink_return" runat="server" 
             NavigateUrl="~/front/ExpChangePro/salesReturn.aspx">退货</asp:HyperLink>
                <br />
        <br />订单详情
        <table border="0">
            <tr>
            ...
            <tr>
                <td colspan="5">收货地址：<asp:TextBox ID="showaddress" runat="server" Height="20px" 
                        Width="642px" ReadOnly="true"></asp:TextBox> 
                </td>
            </tr>
            <tr>
                <td colspan="5">给店家的备注（发票，大小，收件地址等要求):<asp:TextBox 
                        ID="showdescription" runat="server" Height="20px" Width="448px" ReadOnly="true"></asp:TextBox></td>
            </tr>
            <tr>
                <td colspan="5" >
                        ...
                        <ItemTemplate>
                                ...
                                <table border="0" width="800px">
                                    <tr>
                                        ...
                                        <td style="vertical-align: middle; width: 260px;">价格：<%# Eval("Price")%></td>
                                        <td style="vertical-align: middle; width: 260px;">   
